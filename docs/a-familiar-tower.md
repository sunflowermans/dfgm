...
One could imagine Tower Mer as an infinite nesting doll, each tower containing a smaller version of itself. In reality, they are all the same tower: the one set atop the basin-table in [*4A. Model Room* (p. 16)](#4a-model-room). 

Entering or leaving the tower changes an object’s size by a factor of fifty. If someone pushes a twenty-sided die through the window of the miniature tower, a massive icosahedron comes through the full-size window beside them, the die enlarged to about three feet in diameter. If someone reaches inside the double doors of the miniature tower to [*1C. Reception* (p. 9)](#1c-reception) and pulls out a couch, it emerges at roughly two inches across. Peering out the window of [*4A. Model Room* (p. 16)](#4a-model-room), one sees the same room fifty times larger, viewed from the vantage of the miniature tower. Those climbing out the window stand at one-fiftieth their former size, about an inch and a half tall (roughly the size of a 28mm figure). 

For more details, see [Advanced Tower Mechanics (p. 25)](#advanced-tower-mechanics).

<a href="/assets/images/a-familiar-tower/Dice_Window.png" target="_blank"><img src="/assets/images/a-familiar-tower/Dice_Window.png" style="margin:10px 0 10px 10px;"></a>
...
Agitating the water near the tower summons [Athena (p. 27)](#athena-the-fun-loving-aquatic-beast) from the depths, expecting a game of fetch. After, she attempts to goad the party into following her under the water to play in [*0B. Moon Pool* (p. 11)](#0b-moon-pool). 

150 ' below, a 30' boulder rests on the murky bottom. Lining its surface are the faint seams of a magically locked door to the [*–1A. Treasure Vault* (p. 24)](#1a-treasure-vault). Not far away waits the gold cat’s-eye key that [Athena (p. 27)](#athena-the-fun-loving-aquatic-beast) keeps to give to new friends: the key unlocks the secret door from [*5B. Bedroom* (p. 19)](#5b-bedroom) to [*5C. Albus’s Den* (p. 22)](#5c-albuss-den).
...
* Esmis Mer loves his familiars, especially his cat, [Albus (p. 26)](#albus-the-cat-with-nine-eight-lives).
* The fishdog, [Athena (p. 27)](#athena-the-fun-loving-aquatic-beast), lives in the waters around the tower.
...
* [*Portable Window* (p. 34)](#portable-window).
...
- [ ] [Potion of Speed (p. 34)](#potion-of-speed).
- [ ] [Potion of Luck (p. 34)](#potion-of-luck).
- [ ] [Potion of Giant Strength (p. 34)](#potion-of-giant-strength).
- [ ] Sapphire cradled in a lattice of golden wire (450gp).
- [ ] Recipe for [Potion of Cure Disease (p. 34)](#potion-of-cure-disease). Requires fresh [Fishdog Algae (p. 33)](#fishdog-algae). One use can be brewed in three turns.
- [ ] [Frog’s Breath (p. 33)](#frogs-breath).

{: .monster #vat-spawn}
> **Vat-Spawn**
>
> AC 5 [14], HD 3* (13hp), Att 1 × touch (1d8 + disease), THAC0 17 [+2], MV 60 ' (20′), SV D12 W13 P14 B15 S16 (3), ML 12, AL Chaotic, XP 50
> * **Disease**: Target ages 20 years and becomes infected with a wasting disease, unable to heal. Only magic or a [Potion of Cure Disease (p. 34)](#potion-of-cure-disease) cures it.
...
* Glass vial with a Potion of Healing, which shatters if the chest
  is smashed.
* Blue velvet purse with a [Parlor Coin (p. 34)](#parlor-coin) and 20gp.
...
- [ ] 3 random [spell scrolls (p. 36)](#spells), creased and tucked into the breast pocket of a sunflower-yellow coat.
- [ ] [Feather of Slowed Descent (p. 33)](#feather-of-slowed-descent) extending from the side of a pleated purple fedora. 
- [ ] Amethyst stud earrings (600gp) peeking between the folds of a maritime-patterned handkerchief. 
- [ ] 3 [Exploding Dice (p. 33)](#exploding-dice) slipped into the pocket of threadbare trousers. 
...
> Distances measured relative to a party entering from [*2B. Transport Room* (p. 12)](#2b-transport-room). Wandering encounters are always 1d3 [giant spiders (p. 31)](#spider-giant).
...
<a href="/assets/images/a-familiar-tower/wardrobe_map.png" target="_blank"><img src="/assets/images/a-familiar-tower/wardrobe_map.png" style=" margin: 0 0 10px 10px;"></a>
...
* **A**.  A litter box overflows with dung. 6 [biting flies (p. 27)](#biting-fly-giant) cling to the mess. 2-in-6 chance they notice fresh meat strolling by.
* **B**.  A bejeweled food bowl rests, magically refilled once a day with tuna-flavored brown kibble. 2-in-6 chance of a hungry [pigeon-rat (p. 30)](#pigeon-rats-the-helpless-flock) buried within, gorging.
* **C**.  A cozy enclosure contains a down cat bed and a glass jar with air holes holding [Esmis Mer (p. 29)](#esmis-mer) himself. If working together, he suggests using the [Catnip (p. 33)](#jar-of-catnip) in the [*5B. Bedroom* (p. 19)](#5b-bedroom) nightstand to overcome Albus.
* **D**. A [sea-green quartz marble (p. 35)](#sea-green-quartz) hangs on a string tied to the platform above. 
* **E**. The top platform holds a polished silver chest set with a yellow cat’s eye. The eye jerks unnaturally to track movement on its perch. Those that meet its gaze must save or be paralyzed for 2d4 turns. The lid gives a soft purr when opened. The chest contains:
  * 2,200gp in gems and coins. 
  * [Pin (p. 34)](#pin).
  * [Cloak of Invisibility (p. 32)](#cloak-of-invisibility).
  * Five random miniature [spell scrolls (p. 36)](#spells)—less than a quarter of an inch in length.

<div style="display: flex; gap: 10px;">
  <div>
  <a href="/assets/images/a-familiar-tower/kitty_condo.png" target="_blank" style="flex: 1;">
    <img src="/assets/images/a-familiar-tower/kitty_condo.png" style="width: 100%;">
  </a>
<center>Player Map</center>
</div>


<div>
  <a href="/assets/images/a-familiar-tower/Cat_Tree_with_pointcrawl_purple.png" target="_blank" style="flex: 1;">
    <img src="/assets/images/a-familiar-tower/Cat_Tree_with_pointcrawl_purple.png" style="width: 100%;">
  </a>
<center>Referee Map</center>
</div>
</div>
...
Tower Mer is indestructible and anchored to its point in space, remaining fixed even if the basin-table beneath it is destroyed. Only the red switch in [*0B. Moon Pool* (p. 11)](#0b-moon-pool) disables the anchoring, accessible by reaching under and inside the bottom of the miniature tower. Flipping this switch allows the tower to move while touched; once released, it floats in place until touched again. Gravity inside the tower never shifts, no matter how the structure turns or orients. Flipping the switch a second time re-anchors the tower. 

Facing the open window of the miniature tower toward the open window of [*4A. Model Room* (p. 16)](#4a-model-room) shows an endless series of towers, like an infinite mirror. Moving the miniature tower out of the window or the first-floor double doors shows a ripple of larger and smaller towers extending through the astral plane in either direction. Those attempting to exit the tower in this way quickly become lost in the void. By contrast, moving the miniature tower through the [sea-green quartz (p. 35)](#sea-green-quartz) exit door in [*2B. Transport Room* (p. 12)](#2b-transport-room) causes the tower to implode over ten seconds, destroying everything inside. At the point of collapse, a swirling black portal to the astral plane appears from nowhere, doubling in size with each passing day.
...
<a href="/assets/images/a-familiar-tower/albus_portrait.png" target="_blank"><img src="/assets/images/a-familiar-tower/albus_portrait.png" style="float: right; margin:10px 0 10px 10px; max-width: 50%;"></a>

Pink tabby with a confident swagger and a scar over his left eye. Albus wants Carbuncle dead—preferably served as dinner—and he covets Athena’s barrel of fish from [*0B. Moon Pool* (p. 11)](#0b-moon-pool). Water remains his one true fear: he avoids it with the instinctual terror of every cat, yet when pressed, he hints that the cause proves far more unsettling. If given a [Communicator (p. 32)](#communicator), Albus speaks in a cold and calculating voice, laced with disdain.
...
> * **Lives**: When slain, his body disintegrates and instantly reforms in [*5C. Albus’s Den* (p. 22)](#5c-albuss-den), bearing an additional scar over his eye. This rebirth occurs up to eight times in total. Albus has already used one of his lives. [x] [ ] [ ] [ ] [ ] [ ] [ ] [ ] [ ]


## Athena, the Fun-Loving Aquatic Beast

<a href="/assets/images/a-familiar-tower/athena_portrait.png" target="_blank"><img src="/assets/images/a-familiar-tower/athena_portrait.png" style="float: right; margin:10px 0 10px 10px; max-width: 50%;"></a>
...
When petted, she rolls over to reveal a hairy belly coated in green goo. Once every two weeks, scraping the goo off yields a single dose of [Fishdog Algae (p. 33)](#fishdog-algae). Athena also enjoys sharing her treasures with friends. After a particularly good play session, she dives down into the muck at the bottom of the basin-table and returns with the gold cat’s-eye key, which unlocks the secret door from [*5B. Bedroom* (p. 19)](#5b-bedroom) to [*5C. Albus’s Den* (p. 22)](#5c-albuss-den).
...
<a href="/assets/images/a-familiar-tower/ds_flies.png" target="_blank"><img src="/assets/images/a-familiar-tower/ds_flies.png" style="float: right; margin:10px 0 10px 10px; max-width: 50%;"></a>
...
<a href="/assets/images/a-familiar-tower/edgar_portrait.png" target="_blank"><img src="/assets/images/a-familiar-tower/edgar_portrait.png" style="float: right; margin:10px 0 10px 10px; max-width: 50%;"></a>
...
Mother desires to cure her ailment—without healing, she perishes in two days. She trades her knowledge of the tower for a [Potion of Cure Disease (p. 34)](#potion-of-cure-disease) from [*2C. Workshop* (p. 13)](#2c-workshop)—a task the other pigeon-rats failed at, succumbing to the [vat-spawn (p. 13)](#vat-spawn). She knows that the [sea-green quartz marble (p. 35)](#sea-green-quartz) in [*5C. Albus’s Den* (p. 22)](#5c-albuss-den) is the key to escaping the tower, and that treasure lies hidden in the wardrobe in [*5B. Bedroom* (p. 19)](#5b-bedroom).

Mother wears a [Communicator (p. 32)](#communicator) and speaks warmly and fluently in the common tongue. She worries constantly that, without her guidance and protection, the other pigeon-rats will perish.
...
<a href="/assets/images/a-familiar-tower/pigeon_rat_portrait.png" target="_blank"><img src="/assets/images/a-familiar-tower/pigeon_rat_portrait.png" style="float: right; margin:10px 0 10px 10px; max-width: 50%;"></a>

Jittery rodents uncomfortable with the gift of flight. They are not as stupid as they want you to think. 

If the party appears capable, the pigeon-rats parlay. They lead the party to Mother’s nest at [*0B. Moon Pool* (p. 11)](#0b-moon-pool) so she can explain her predicament and enlist their aid. 

2-in-6 pigeon-rats wear a [Communicator (p. 32)](#communicator). Their vocabulary proves extremely limited, consisting of just a handful of words: _“Mother,” “Sick,” “Help,” “Good,” “Bad,”_ and _“Food.”_
...
<a href="/assets/images/a-familiar-tower/ebony_monk.png" target="_blank"><img src="/assets/images/a-familiar-tower/ebony_monk.png" style="float: right; margin:10px 0 10px 10px; max-width: 50%;"></a>

A robed, bald monk with their finger over their mouth in a quieting gesture. Once per day, the figurine can be activated by saying _“Shhh”_ or mimicking the monk’s gesture, nullifying sound within a 15' radius around the figurine for 2 hours. 4 charges remain.
...
Green goop, the key ingredient to a [Potion of Cure Disease (p. 34)](#potion-of-cure-disease).
...
Bite-sized ruby that stores knowledge and spells. Only [Carbuncle (p. 28)](#carbuncle-the-ruby-spell-armadillo) can safely remove the gem embedded in his forehead—otherwise, it shatters.

When swallowed, the user learns the gem’s functions and memorizes 5 random [spells (p. 36)](#spells). The swallower can cast these memorized spells at any time without using a spell slot, but then forgets the spell. 

Two weeks after swallowing, the swallower forgets uncast spells, but the gem resets, and can be swallowed again to learn another random set of 5 [spells (p. 36)](#spells).
...
Full-length, free-standing mirror framed in pale holly wood. Its edge bears engraved words: *“I am loved. I am enough. I am brave even when I feel fear.”* Those that meet their own reflection and recite the affirmations aloud gain the effects of a [*Potion of Heroism*](/docs/ose-rules/treasures/potions/potion-of-heroism/). The mirror can be used once per day.
...
<a href="/assets/images/a-familiar-tower/portable_window_cropped.png" target="_blank"><img src="/assets/images/a-familiar-tower/portable_window_cropped.png" style="float: right; margin:10px 0 10px 10px; max-width: 50%;"></a>
...
Destination: [Top shelf of the Wardrobe in 5B. Bedroom (p. 20)](#top-shelf-of-the-wardrobe).

### Citrine gold quartz

Sounds of dripping water. Within, a vault’s laden hoard of gold and silver sparkles in firelight.

Destination: [*–1A. Treasure Vault* (p. 24)](#1a-treasure-vault).
...
<div style="display: flex; gap: 10px;">
  <a href="/assets/images/a-familiar-tower/produce_smoke.png" target="_blank" style="flex: 1;">
    <img src="/assets/images/a-familiar-tower/produce_smoke.png" style="width: 100%;">
  </a>

  <a href="/assets/images/a-familiar-tower/tentacle_of_the_worm.png" target="_blank" style="flex: 1;">
    <img src="/assets/images/a-familiar-tower/tentacle_of_the_worm.png" style="width: 100%;">
  </a>
</div>
...
Resources available at [PuzzleDungeon.com](https://puzzledungeon.com).
...
| **1d12** | **Encounter** |
| -------- | -------------------|
| **1**    | [Albus (p. 26)](#albus-the-cat-with-nine-eight-lives) rolls and flops, inviting belly rubs. 1-in-6 chance of biting playfully for 1d6 damage. |
| **2**    | [Albus (p. 26)](#albus-the-cat-with-nine-eight-lives) stalks the party from the shadows. |
| **3**    | [Albus (p. 26)](#albus-the-cat-with-nine-eight-lives) yowls at the party, demanding tribute in the form of blood or treasure. |
| **4**    | Short, sharp barks boom through the tower, like a lion impersonating a dog. [Athena (p. 27)](#athena-the-fun-loving-aquatic-beast) splashes about in [*1A. Tabletop Water* (p. 6)](#1a-tabletop-water), already trapped within the tower. Boats in the water capsize. |
| **5**    | 1d8 [giant biting flies (p. 27)](#biting-fly-giant) search for fresh meat. |
| **6**    | 1d3 [giant spiders (p. 31)](#spider-giant) wait for the right moment to ensnare the party. |
| **7**    | A giant [pigeon-rat (p. 30)](#pigeon-rats-the-helpless-flock) blocks the path. If mutilated, the carcass attracts 1d8 [giant biting flies (p. 27)](#biting-fly-giant) in 2 turns. |
| **8**    | A normal spider wraps its silk around a trapped [pigeon-rat (p. 30)](#pigeon-rats-the-helpless-flock) who shouts “HELP” through a [Communicator (p. 32)](#communicator). |
| **9**    | 2d8 [pigeon-rats (p. 30)](#pigeon-rats-the-helpless-flock) and their leader, Reginald the Bold, wearing a [Communicator (p. 32)](#communicator). |
| **10**    | [Edgar (p. 29)](#edgar-the-battle-scarred-giant-cockroach) postures and blocks the path, hissing with rage. |
| **11**    | [Edgar (p. 29)](#edgar-the-battle-scarred-giant-cockroach) curiously probes the party with his feelers. He attacks if the party split up or show signs of weakness. |
| **12**    | A ravenous [Edgar (p. 29)](#edgar-the-battle-scarred-giant-cockroach) consumes all in his path. |

...
- **Open doors:** The chance of success with attempts to force open a stuck door (see [Dungeon Adventuring](/docs/ose-rules/adventures/dungeon-adventuring/)).
...
- **Magic saves:** Is applied to saving throws (see [Saving Throws](/docs/ose-rules/adventures/saving-throws/)) versus magical effects. This does not typically include saves against breath attacks but may apply to any other saving throw category.
...
- **Initiative:** Modifies the character’s initiative roll if the optional rule for individual initiative is used (see [Combat](/docs/ose-rules/adventures/combat/)).

...
Roll 3d6 in order of your character’s ability scores: Strength, Dexterity, Constitution, Intelligence, Wisdom, and Charisma (see [Ability Scores](/docs/ose-rules/characters/ability-scores/)).
...
Select one of the classes available (see [Character Classes](/docs/ose-rules/classes/character-classes/)), bearing in mind some classes' minimum ability score requirements. The chosen class determines your character’s race—unless a demihuman class is selected, the character is human.
...
Now that your character’s ability scores are fixed, note any associated bonuses or penalties (see [Ability Scores](/docs/ose-rules/characters/ability-scores/)).
...
If using the optional rule for [Ascending AC](/docs/ose-rules/characters/creating-a-character/#ascending-ac), record your attack bonus on your character sheet, instead of the attack matrix quick reference.
...
Determine your character’s hit points by rolling the die type appropriate to the chosen class. Modifiers for high or low Constitution apply (see [Ability Scores](/docs/ose-rules/characters/ability-scores/)). Your character always starts with at least 1 hit point, regardless of the CON modifier.
...
Decide whether your character is Lawful, Neutral, or Chaotic (see [Alignment](/docs/ose-rules/characters/alignment/)), and note this on your character sheet.

## 9. Note Known Languages

Your character’s native languages are listed in the class description. This includes the common tongue and the character’s alignment language—see [Languages](/docs/ose-rules/characters/languages/). Characters with high INT may also choose additional languages from the list available in the setting.

## 10. Buy Equipment

Your character starts play with 3d6 × 10 gold pieces (see [Wealth](/docs/ose-rules/equipment-and-services/wealth/)). You may spend as much of this money as you wish to equip your character for adventure, consulting the equipment lists under [Equipment & Services](/docs/ose-rules/equipment-and-services/).
...
- **Armor:** The armor worn determines your character’s base AC. See the equipment lists under [Armor](/docs/ose-rules/equipment-and-services/weapons-and-armor/#armor).
- **Dexterity:** A nimble character is more difficult to attack (see [Dexterity](/docs/ose-rules/characters/ability-scores/#dexterity-dex) under [Ability Scores](/docs/ose-rules/characters/ability-scores/)).

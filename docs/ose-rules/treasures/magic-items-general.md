...
- **Type of item not specified:** Otherwise, first roll on the [Magic Item Type](/docs/ose-rules/monsters/monster-descriptions/#m) table below to determine the type of the item, then roll on the table for that type (found by following the links in the table).

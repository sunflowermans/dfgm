---
title: Ring of Controlling Animals
parent: Rings
nav_order: 999
---
...
- **When concentration ends:** The referee should make a reaction roll with a -1 penalty (see [Encounters](/docs/ose-rules/adventures/encounters/) to determine the animals’ behavior.

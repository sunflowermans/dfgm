...
3. For gems, jewelry, and magic items, the procedures for determining the value and properties of the items in the hoard are found in [Gems and Jewellery](/docs/ose-rules/treasures/gems-and-jewellery/) and [Magic Items](/docs/ose-rules/treasures/magic-items-general/).

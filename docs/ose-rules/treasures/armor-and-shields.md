...
**Weight:** If using the optional rules for detailed encumbrance (see [Encumbrance](/docs/ose-rules/adventures/time-weight-movement/#encumbrance)), the enchanted armor’s encumbrance value is 50% less than that of normal armor.

...
- **Affected creatures:** Are afflicted by the drums’ enchantment of fear; they must **save versus spells** or make a morale check with a -2 penalty (if the optional morale rules are being used—see [Morale](/docs/ose-rules/adventures/morale/).

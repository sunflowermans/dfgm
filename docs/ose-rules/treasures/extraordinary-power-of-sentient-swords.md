---
title: Extraordinary Powers of Sentient Swords
parent: Treasures
nav_order: 14
---
...
The wielder can teleport, per the magic-user spell (see [Teleport](/docs/ose-rules/magic/magic-user-spells/teleport/)).
...
- **Searching:** When used for searching (see [Dungeon Adventuring](/docs/ose-rules/adventures/dungeon-adventuring/)), the wielder is guaranteed to notice secret doors or traps in the 10’ square area being examined.

...
**Asterisks:** One or more asterisks after the HD number indicate the number of special abilities the monster has for XP calculation (see [Awarding XP](/docs/ose-rules/running-adventures/awarding-xp/)).
...
The monster’s ability to hit foes in combat is determined by its Hit Dice (see the [Attack Matrix](/docs/ose-rules/adventures/combat-tables/#attack-matrix) table under [Combat Tables](/docs/ose-rules/adventures/combat-tables/)).
...
The monster’s likelihood to persist in battle. See [Morale](/docs/ose-rules/adventures/morale/).
...
The letter code determines the amount and type of treasure possessed by the monster(s) (see [Treasure Types](/docs/ose-rules/treasures/treasure-types/)). The letters listed are used as follows:

- **A to O:** Indicate a hoard: the sum wealth of a large monster or a community of smaller monsters, usually hidden in the lair. For monsters with a lair encounter size (see [Number Appearing](/docs/ose-rules/monsters/general/#number-appearing-na)) greater than 1d4, the amount of treasure in the hoard may be reduced if the number of monsters is below average.
...
All non-human monsters have infravision (see [Darkness](/docs/ose-rules/adventures/hazards-and-challenges/#darkness) under [Hazards and Challenges](/docs/ose-rules/adventures/hazards-and-challenges/)). Unless specified in a monster’s description, this allows monsters to see up to 60’ in the dark.

## Languages

20% of intelligent monsters speak Common (see [Languages](/docs/ose-rules/characters/languages/)) unless the monster description states otherwise. Many intelligent monster species also have their tongue.

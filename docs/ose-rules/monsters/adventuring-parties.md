...
- **Magic items:** Per individual: there is a chance of the NPC having a magic item from each suitable magic item sub-table (see [Magic Items](/docs/ose-rules/treasures/magic-items-general/)). The chance per sub-table is 5% per level of the NPC. Rolled items that the NPC cannot use should be ignored (no re-roll).

## High-Level Cleric

A high-level cleric and party ([Mounts](/docs/ose-rules/equipment-and-services/mounts/) and [Magic Items](/docs/ose-rules/treasures/magic-items-general/) as per [Expert Adventurers](/docs/ose-rules/monsters/adventuring-parties/#expert-adventurers).
...
A high-level fighter and a group of retainers, often on their way to or from war ([Mounts](/docs/ose-rules/equipment-and-services/mounts/) and [Magic Items](/docs/ose-rules/treasures/magic-items-general/) as per [Expert Adventurers](/docs/ose-rules/monsters/adventuring-parties/#expert-adventurers).
...
A high-level magic-user, accompanied by their apprentices and a group of hired guards, often on a quest for arcane lore ([Mounts](/docs/ose-rules/equipment-and-services/mounts/) and [Magic Items](/docs/ose-rules/treasures/magic-items-general/) as per [Expert Adventurers](/docs/ose-rules/monsters/adventuring-parties/#expert-adventurers).

...
Arcane spell casters memorize spells from spell books (see [Spell Books](/docs/ose-rules/magic/spell-books/)) and are thus limited to choosing from the spells in their spell book, which must be at hand.

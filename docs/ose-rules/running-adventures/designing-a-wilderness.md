...
Locate a base town for player characters on the map, typically close to a river or road near the center of the map. This is where the play will begin. The guidelines in [Designing a Base Town](/docs/ose-rules/running-adventures/designing-a-base-town/) may flesh out the base town.
...
**Standard tables:** The standard encounter tables (see [Wilderness Encounters may be suited to some areas of the campaign map](/docs/ose-rules/monsters/monster-descriptions/#w)).

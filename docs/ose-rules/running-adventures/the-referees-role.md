...
**Preparation:** Before the game begins, the adventure should be planned and the required maps drawn. Advice on adventure design is found in [Adventure Scenarios](/docs/ose-rules/running-adventures/adventure-scenarios/), [Designing a Dungeon](/docs/ose-rules/running-adventures/designing-a-dungeon/), [Designing a Wilderness,](/docs/ose-rules/monsters/monster-descriptions/#d) and [Designing a Base Town](/docs/ose-rules/running-adventures/designing-a-base-town/).
...
**Resolving actions:** When a player wishes to do something not covered by a standard rule, the referee must consider how to determine the outcome. Sometimes, the situation can be dealt with by deciding what would happen. Sometimes, the referee may require the player to make an ability check (see [Ability Checks](/docs/ose-rules/adventures/ability-checks/)) or a saving throw (see [Saving Throws](/docs/ose-rules/adventures/saving-throws/)) to determine what happens. Other times, the referee may judge the likelihood of the action succeeding (e.g., expressed as a percentage or X-in-6 chance), tell the player the chances, and let them decide whether to take the risk.

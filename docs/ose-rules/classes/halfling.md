...
If using the optional rule for individual initiative (see [Combat](/docs/ose-rules/adventures/combat/)), halflings get a bonus of +1 to initiative rolls.

## Listening at Doors

Halflings have a 2-in-6 chance of hearing noises (see [Dungeon Adventuring](/docs/ose-rules/adventures/dungeon-adventuring/)).

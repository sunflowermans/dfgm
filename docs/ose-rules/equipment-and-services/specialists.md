...
**Recreating potions:** Based on a sample or recipe, an alchemist can produce a potion at twice the normal speed and for half the normal cost (see [Magical Research](/docs/ose-rules/magic/magical-research/)).
...
Apprentices who may work under an armorer to increase the production rate (see [Armorer](/docs/ose-rules/equipment-and-services/specialists/#armorer)).

## Blacksmith

Craftsmen trained in the art of forging metal. Blacksmiths may be hired to work under an armorer to increase the rate of production (see [Armorer](/docs/ose-rules/equipment-and-services/specialists/#armorer)).

## Engineer

Engineers are experts in planning and managing construction projects, for example, building strongholds (see [Construction](/docs/ose-rules/monsters/monster-descriptions/#c)).
...
Experts in navigating the high seas. A ship that travels beyond sight of land becomes lost if a navigator is not aboard (see [Waterborne Adventuring](/docs/ose-rules/adventures/waterborne-adventuring/)).

...
**Holy water:** Water blessed by a holy person, stored in a special vial for religious rituals. Holy water inflicts damage on undead monsters (see [Weapon Combat Stats](/docs/ose-rules/monsters/monster-descriptions/#w)). It loses its power if transferred from the blessed vials it is stored in.

**Iron spikes:** These may be used for wedging doors open or shut (see [Dungeon Adventuring](/docs/ose-rules/adventures/dungeon-adventuring/)), as an anchor to attach a rope to, and for many other purposes.
...
- **Throwing:** A flask of oil may be thrown (see [Weapons And Armor](/docs/ose-rules/equipment-and-services/weapons-and-armor/)).
...
**Torch:** When lit, casts light in a 30’ radius and burns for 1 hour (6 turns). Torches may also be used in combat (see [Weapons And Armor](/docs/ose-rules/equipment-and-services/weapons-and-armor/)).

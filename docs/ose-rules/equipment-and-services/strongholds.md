...
3. **Design:** The player creates a plan for the stronghold and calculates the costs (see construction prices in [Structures](/docs/ose-rules/monsters/monster-descriptions/#s).
4. **Review:** The referee should review and approve the player’s plans.
5. **Hire engineers:** For every 100,000gp cost of the stronghold, the PC must hire one engineer (see [Specialists](/docs/ose-rules/equipment-and-services/specialists/)).

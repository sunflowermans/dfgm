...
**Slow:** The character acts last in each combat round (see [Combat](/docs/ose-rules/adventures/combat/)).
...
If the optional rules for encumbrance are used (see [Encumbrance](/docs/ose-rules/equipment-and-services/weapons-and-armor/#encumbrance)), armor and weapons carried are treated as follows.

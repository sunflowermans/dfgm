...
5. **Description:** The referee describes the regions passed through and any sites of interest the party has, asking players for their actions, as required. If monsters are encountered, follow the procedure described in [Encounters](/docs/ose-rules/adventures/encounters/).
...
- **Sailing:** The movement rate of sailing vessels is affected by the prevailing wind conditions (see [Wind Conditions](/docs/ose-rules/adventures/waterborne-adventuring/#wind-conditions)).
...
- **12:** Gale or storm; sailing vessels’ speed tripled (see [Gales and Storms](/docs/ose-rules/adventures/waterborne-adventuring/#gales-and-storms)).
...
|  11  | Near gale       | Sailing movement rate doubled. See [Near Gales](/docs/ose-rules/adventures/waterborne-adventuring/#near-gales).        |
|  12  | Gale or storm   | Sailing movement rate tripled. See [Gales and Storms](/docs/ose-rules/adventures/waterborne-adventuring/#gales-and-storms).  |

...
Mercenaries (see [Mercenaries](/docs/ose-rules/equipment-and-services/mercenaries/)) have a morale rating and check morale exactly like monsters.
...
Retainers signed up to work as adventurers, so are not frightened off at the first sign of danger. Retainers do not make morale checks in combat, but a loyalty check may be required in extreme peril (see [Retainers](/docs/ose-rules/equipment-and-services/retainers/)).

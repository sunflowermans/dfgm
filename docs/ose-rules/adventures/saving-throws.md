...
**Monsters:** Most monsters use the saving throw table under [Combat Tables](/docs/ose-rules/adventures/combat-tables/). Some monsters’ descriptions may note that they use the table for a specific character class.

...
4. **Description:** The referee describes the terrain passed through and any sites of interest the party encounters, asking players for their actions, as required. If monsters are encountered, follow the procedure described in [Encounters](/docs/ose-rules/adventures/encounters/).
...
**Miles per day:** The distance a creature can fly in a day is double the distance it can travel overland (see [Overland Travel](/docs/ose-rules/adventures/wilderness-adventuring/#overland-travel)). For example, a creature with a movement rate of 120’ could travel 24 miles overland but could fly 48 miles in a day.
...
Foraging for herbs, fruits, nuts, etc., can be performed alongside normal movement (see [Overland Travel](/docs/ose-rules/adventures/wilderness-adventuring/#overland-travel)). The party has a 1-in-6 chance per day of finding enough food for 1d6 human-sized beings.

## Hunting

Hunting animals takes up a complete day, with no traveling or resting possible. When hunting, there is a 1-in-6 chance of encountering animals suitable for eating (if they can be caught!). This is in addition to the normal chance of random encounters (see [Wandering Monsters](/docs/ose-rules/adventures/wilderness-adventuring/#wandering-monsters)).
...
**Distance:** Wandering monsters are encountered 4d6 × 10 yards away. If either side is surprised (see [Encounters](/docs/ose-rules/adventures/encounters/)), this is reduced to 1d4 × 10 yards.

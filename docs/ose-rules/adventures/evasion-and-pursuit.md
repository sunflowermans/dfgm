...
**Time:** This is measured in rounds (see [Time, Weight, Movement](/docs/ose-rules/adventures/time-weight-movement/)).
...
The chance of evasion is a percentile roll. If the percentile evasion roll fails, a pursuit occurs. Surprise (see [Encounters](/docs/ose-rules/adventures/encounters/)) determines the chance of evasion:

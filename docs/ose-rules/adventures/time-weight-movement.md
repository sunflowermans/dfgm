...
The referee should refer to the characters' movement rates to determine how long it takes for characters to move from one area to the next (see [Game Statistics](/docs/ose-rules/characters/game-statistics/)).
...
**Turns:** 10 minutes of game time. There are six turns in an hour. Time is measured in turns when exploring dungeons (see [Dungeon Adventuring](/docs/ose-rules/adventures/dungeon-adventuring/)).

**Rounds:** 10 seconds of game time. There are 60 rounds in a turn. Time is measured in rounds during encounters, especially in combat (see [Encounters](/docs/ose-rules/adventures/encounters/) and [Combat](/docs/ose-rules/adventures/combat/)).
...
Weight measures typically come into play only when discussing how much characters can carry (see [Encumbrance](/docs/ose-rules/adventures/time-weight-movement/#encumbrance) below). As coins are the most common treasure adventurers find, all weights are measured in coins. (Ten coins are equivalent to one pound.)

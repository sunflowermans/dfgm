...
Parties carrying a light in a dark environment usually cannot surprise others (see [Encounters](/docs/ose-rules/adventures/encounters/)) because the light gives away their presence.
...
The chance of the party becoming lost depends on the type of terrain being explored (see [Wilderness Adventuring](/docs/ose-rules/adventures/wilderness-adventuring/) and [Waterborne Adventuring](/docs/ose-rules/adventures/waterborne-adventuring/).
...
See [Dungeon Adventuring](/docs/ose-rules/adventures/dungeon-adventuring/), [Wilderness Adventuring](/docs/ose-rules/adventures/wilderness-adventuring/), and [Waterborne Adventuring](/docs/ose-rules/adventures/waterborne-adventuring/) for specific details.

...
3. **Description:** The referee describes what happens. If monsters are encountered, follow the procedure described in [Encounters](/docs/ose-rules/adventures/encounters/).
...
Some doors are hidden or concealed. Adventurers may search a 10’ × 10’ area for secret doors (see [Searching](/docs/ose-rules/adventures/dungeon-adventuring/#searching)).
...
**Forcing:** The chance of forcing open a stuck door depends on the character’s Strength (see [Ability Scores](/docs/ose-rules/characters/ability-scores/)).

**Surprise:** A failed attempt to force open a door eliminates any possibility of surprise (see [Encounters](/docs/ose-rules/adventures/encounters/)) that the party may have against any monsters on the other side of the door.
...
Adventurers may search a 10’ × 10’ area for room traps. If the search succeeds, the trap is discovered (see [Searching](/docs/ose-rules/adventures/dungeon-adventuring/#searching)).
...
Characters with the ability to find treasure traps (as noted in their class description may choose to search items (e.g., chests, locks) for traps (see [Searching](/docs/ose-rules/adventures/dungeon-adventuring/#searching)).
